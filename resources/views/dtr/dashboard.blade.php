    ...
    <div class="layout-sidebar">
        <div class="sidebar no-print">
            ...
            <div class="sidebar-footer">
                <a href="{{ config('app.dts_url') }}/dts" style="color:rgba(255,255,255,0.8);font-size:12px;text-decoration:none;display:block;padding:6px 0;margin-bottom:4px;">&#128196; Document Tracking System</a>
